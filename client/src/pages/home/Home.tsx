...
export const Home = () => {
    ...
    return (
        <div className={"flex flex-col gap-5 w-full h-[100vh] justify-center items-center"}>
            <div className={"flex h-[90%] flex-col gap-2 justify-center items-center"}>
            ...
            <div className={"grid grid-cols-3 w-[95%]"}>
                <div></div>
                <div className={"opacity-60 text-center font-extralight text-xs hover:underline"}><a href={"https://github.com/Yaon-C2H8N2/bahclePlayer"}>Made with ❤️ by yaon</a></div>
                <div className={"opacity-60 text-right font-extralight text-xs"}>{appInfo?.version}</div>
            </div>
        </div>
    )
}